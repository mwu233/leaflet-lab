...
/*function createTextControls(response, map, attrs){
    ...
    $('.filter').html('<img src="img/filter.png" style = "width:90px">');
...
function createTextControls(response, map, attrs){
    var InputTextControl = L.Control.extend({
        ...
        onAdd: function (map) {
            ...
            $(container).append('<label>Population range:</label>');
            /*$(container).append('<input type="text" id="amount" readonly style="border:0; color:#f6931f; font-weight:bold;"/>');*/
            //$(container).append('<input type="range" multiple="" value="0,100">');
