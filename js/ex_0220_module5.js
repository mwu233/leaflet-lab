// before class
// $('#mydiv') is recommended
// comment
// hand in assignments with github link and zip file as well
...
function createSequenceControls(map, attributes){
    ...
    $('#reverse').html('<img src="img/reverse.png" style = "height:40px">');
    $('#forward').html('<img src="img/forward.png" style = "height:40px">');
